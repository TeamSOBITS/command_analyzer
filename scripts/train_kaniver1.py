...
class CommandAnalyzer():
    def __init__(self) -> None:
        ...
        self.vectors=FastText(language="en")         # GloVe(name='840B', dim=300) or FastText(language="en")
        ...
        self.val_text_data, self.test_text_data, self.val_label_data, self.test_text_data = train_test_split(self.val_text_data, self.val_label_data, test_size= 2/3)
        ...
        text_vector = self.vectors.get_vecs_by_tokens(['clab', 'choco'])
